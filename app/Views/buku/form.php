...
class='text-danger'>*</span></label>
 <input type='text' name='kode_buku' class='formcontrol'
...
class='text-danger'>*</span></label>
 <input type='text' name='penulis' class='formcontrol'
 value='<?= esc(old('penulis',
$buku['penulis'] ?? '')) ?>' required>
 </div>
<div class='mb-3'>
    <label class='form-label fw-bold'>Penerbit</label>
 <input type='text' name='penerbit' class='formcontrol'
...
Terbit</label>
 <input type='number' name='tahun' class='formcontrol'
