...
<form method="GET" action="<?= base_url('buku') ?>" class="mb-4">
    <div class="input-group">
        <input type="text" name="q" class="form-control" placeholder="Cari judul, penulis, atau penerbit..." value="<?= esc($keyword) ?>">
                ...
                <?php foreach ($buku as $i => $b): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <small class="text-muted"><?= esc($b['penerbit'] ?? '-') ?>, <?= esc($b['tahun'] ?? '-') ?></small>
                        </td>
                        <td><?= esc($b['penulis']) ?></td>
                        <td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= base_url('buku/hapus/'.$b['id']) ?>" class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Yakin ingin menghapus buku \&quot;<?= esc($b['judul'], 'js') ?>\&quot;?')">
